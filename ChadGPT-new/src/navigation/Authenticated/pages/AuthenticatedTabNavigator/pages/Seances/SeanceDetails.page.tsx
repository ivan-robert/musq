...
import { useBulkFetchSeances } from "#modules/Seance/view/readSeances/useFetchSeances";
...
export const SeanceDetailsPage = ({
  route,
  navigation,
}: NativeStackScreenProps<RootStackNavigatorParamList, "SeanceDetails">) => {
  ...
  return (
    <PageTemplate>
      ...
      />
      <PageHeader
        headerText={DateTime.fromISO(chosenSeance.startDate).toLocaleString()}
